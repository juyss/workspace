    ...
    <div class="layadmin-user-login-main">
        ...
        <form id="login_form" action="${pageContext.request.contextPath}/login" method="post">
            ...
            <div
                ...
                <div class="layui-form-item">
                    <button class="layui-btn layui-btn-fluid" type="submit" lay-submit
...
<script src="${PATH}/layui/jquery.min.js" type="text/javascript"></script>
<script>
    layui.use(['element', 'form'], function () {
        let element = layui.element, form = layui.form, layer = layui.layer;
        form.render();
