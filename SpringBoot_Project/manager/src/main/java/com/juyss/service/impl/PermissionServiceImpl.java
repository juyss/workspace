...
import com.juyss.entity.SysPermission;
import com.juyss.entity.SysRolePermission;
import com.juyss.entity.SysUserRole;
import com.juyss.mapper.SysPermissionMapper;
...
public class PermissionServiceImpl extends ServiceImpl<SysPermissionMapper, SysPermission> implements PermissionService {
    ...
    public void deleted(String permissionId) {
        ...
        //获取下一级
        List<SysPermission> children = sysPermissionMapper.selectList(Wrappers.<SysPermission>lambdaQuery().eq(SysPermission::getPid, permissionId));
        if (!children.isEmpty()) {
