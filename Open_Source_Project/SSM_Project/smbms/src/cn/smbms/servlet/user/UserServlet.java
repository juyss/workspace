...
public class UserServlet extends HttpServlet {
	...
	private void query(HttpServletRequest request, HttpServletResponse response)
    	...
    	if(pageIndex != null){
    		try{
    			currentPageCode = Integer.valueOf(pageIndex);
    	...
    	pages.setCurrentPageCode(currentPageCode);
    	...
    	if(currentPageCode < 1){
    		currentPageCode = 1;
    	}else if(currentPageCode > totalPageCount){
    		currentPageCode = totalPageCount;
    	}
		
		
		userList = userService.getUserList(queryName,queryUserRole,currentPageCode, pageSize);
		...
		request.setAttribute("currentPageNo", currentPageCode);
