package com.github.tangyi.tools.utils.wx.enums;
...
public enum EnumWxMpStatus {
    ...
    EnumWxMpStatus(int code, String label) {
        this.code = code;
        this.label = label;
    }
     ...
     * 通过错误代码查找其中文含义
     */
    public static EnumWxMpStatus getByCode(Integer code) {
