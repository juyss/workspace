...
import com.icepoint.framework.restdoc.constant.GlobalConstants;
...
public class MojoUtils {
    ...
    public static ApiConfig buildConfig(File configFile, String projectName, MavenProject project,
            List<String> projectArtifacts, Log log) throws MojoExecutionException {
        try {
     ...
     * addSourcePath
     */
    private static void addSourcePaths(MavenProject project, ApiConfig apiConfig, List<String> projectArtifacts,
            Log log) {
            ...
            if (null != mavenProject) {
                if (mavenProject.getBasedir() == null) {
                    ...
                    for (String module : modules) {
                        moduleList.put(groupId + ":" + module, mavenProject.getBasedir() + GlobalConstants.FILE_SEPARATOR +
                                module + GlobalConstants.FILE_SEPARATOR + GlobalConstants.SOURCE_CODE_PATH);
                    }
