 ...
 * under the License.
 */
package com.icepoint.framework.restdoc.mojo;

import com.icepoint.framework.restdoc.constant.GlobalConstants;
import com.icepoint.framework.restdoc.model.ApiConfig;
import com.icepoint.framework.restdoc.util.ArtifactFilterUtil;
import com.icepoint.framework.restdoc.util.ClassLoaderUtil;
import com.icepoint.framework.restdoc.util.FileUtil;
import com.icepoint.framework.restdoc.util.MojoUtils;
...
public abstract class BaseDocsGeneratorMojo extends AbstractMojo {
    ...
    private List<Artifact> getArtifacts(List<DependencyNode> dependencyNodes) {
        ...
        for (DependencyNode dependencyNode : dependencyNodes) {
            ...
            if (!children.isEmpty()) {
                artifacts.addAll(getArtifacts(children));
            }
        }
        return artifacts;
    }
