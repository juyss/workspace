...
import com.icepoint.framework.restdoc.constants.DocLanguage;
import com.icepoint.framework.restdoc.constants.HighlightStyle;
import com.icepoint.framework.restdoc.constants.TemplateVariable;
...
import com.icepoint.framework.restdoc.util.BeetlTemplateUtil;
...
public class DocBuilderTemplate extends BaseDocBuilderTemplate {
    ...
    public void buildSingleApi(ProjectDocConfigBuilder projectBuilder, String controllerName, String template, String fileExtension) {
        ...
        mapper.binding(TemplateVariable.NAME.getVariable(), doc.getName());
        mapper.binding(TemplateVariable.LIST.getVariable(), doc.getList());
        FileUtil.writeFileNotAppend(mapper.render(), config.getOutPath() + DocGlobalConstants.FILE_SEPARATOR + doc.getName() + fileExtension);
    }
