 ...
 * under the License.
 */
package com.icepoint.framework.restdoc.helper;

import com.icepoint.framework.restdoc.builder.ProjectDocConfigBuilder;
import com.icepoint.framework.restdoc.constants.DocAnnotationConstants;
import com.icepoint.framework.restdoc.constants.DocGlobalConstants;
import com.icepoint.framework.restdoc.constants.DocTags;
import com.icepoint.framework.restdoc.constants.ValidatorAnnotations;
...
import com.icepoint.framework.restdoc.util.JavaClassUtil;
import com.icepoint.framework.restdoc.util.JavaClassValidateUtil;
    ...
    public static List<ApiParam> buildParams(String className, String pre, int level, String isRequired, boolean isResp,
        ...
        if (JavaClassValidateUtil.isPrimitive(simpleName)) {
            ...
            for (DocJavaField docField : fields) {
                ...
                CustomField customRequestField = projectBuilder.getCustomReqFieldMap()
                        .get(simpleName + "." + fieldName);
                ...
                for (JavaAnnotation annotation : javaAnnotations) {
                    ...
                    if (DocAnnotationConstants.SHORT_JSON_IGNORE.equals(simpleAnnotationName)) {
                        ...
                        if (null != annotation.getProperty(DocAnnotationConstants.SERIALIZE_PROP)) {
                            ...
                            fieldName = StringUtil.removeQuotes(annotation.getProperty(DocAnnotationConstants.NAME_PROP)
                                    .toString());
                        }
                ...
                if (JavaClassValidateUtil.isPrimitive(subTypeName)) {
                    ...
                    String processedType = isShowJavaType ? typeSimpleName : DocClassUtil.processTypeNameForParams(typeSimpleName
                            .toLowerCase());
                    ...
                    if (typeSimpleName.length() == 1) {
                        ...
                        processedType = isShowJavaType ? typeSimpleName : DocClassUtil.processTypeNameForParams(typeSimpleName
                                .toLowerCase());
                    }
                    param.setType(processedType);
                    ...
                    if (javaClass.isEnum()) {
                        ...
                        String valType = DocClassUtil.getMapKeyValueType(gNameTemp).length == 0 ? gNameTemp : DocClassUtil
                                .getMapKeyValueType(gNameTemp)[1];
