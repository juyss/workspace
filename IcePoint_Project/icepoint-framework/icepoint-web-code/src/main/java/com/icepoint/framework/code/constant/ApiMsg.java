...
public class ApiMsg {
     ...
     * 敏感词
     */
    public static final int KEY_SENSITIVE_WORDS= 407;
    ...
    static {
        ...
        CODE_MAP.put(EXPIRED, "失效");
        CODE_MAP.put(INVALID, "非法");
        CODE_MAP.put(DENIED, "拒绝");
    }
    ...
    static {
        ...
        KEY_MAP.put(KEY_SENSITIVE_WORDS, "存在敏感词不允许提交");
    }
