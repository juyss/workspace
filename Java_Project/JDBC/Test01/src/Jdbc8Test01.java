...
public class Jdbc8Test01 {
    ...
    public void Test01() {
        ...
        // MySQL 8.0 以上版本 - JDBC 驱动名及数据库 URL(dailytext)
        final String JDBC_DRIVER = "com.mysql.cj.jdbc.Driver";
        final String DB_URL = "jdbc:mysql://localhost:3306/dailytext?useSSL=false&serverTimezone=UTC";


        // 数据库的用户名与密码，需要根据自己的设置
        final String USER = "root";
        final String PASS = "102850";
